...
if (@$_GET['page'] == 'print' && isset($_GET['print']))
    printClearance($_GET['print']);
...
$getData = "SELECT `id` FROM `passenger`";
$exec = mysqli_query($conn, $getData);
...
<head>
    ...
    <title>
        <?php echo SITE_NAME, ' - Passenger\'s Account' ?>
    </title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-success elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="individual.php?page=cancel"
                                class="nav-link <?php echo (@$_GET['page'] == 'cancel') ? 'active' : ''; ?>">
                        ...
                        <li class="nav-item">
                            <a href="/train/pro/EditAcc.php?id= <?= $uid ?>"
                                class="nav-link <?php echo (@$_GET['page'] == 'EditAcc') ? 'active' : ''; ?>">
        ...
        <div class="content-wrapper">
            ...
            elseif ($_GET['page'] == 'cancel')
                include 'individual/cancel.php';
            elseif ($_GET['page'] == 'upload')
                include 'individual/upload.php';
            elseif ($_GET['page'] == 'editAcc')
                include '../EditAcc.php';
