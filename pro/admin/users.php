                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>
                                                                Full Name : <input class="form-control" type="text"
                                                                    value="<?php echo $fetch['first_fee'] ?>" name="name"
                                                                    required id="">
                                                            </p>
                                                            <p>
                                                                Email : <input class="form-control" type="text"
                                                                    value="<?php echo $fetch['second_fee'] ?>" name="email"
                                                                    required id="">
                                                            </p>
                                                            <p>
                                                                Contact : <input class="form-control" type="text"
                                                                    value="<?php echo $fetch['second_fee'] ?>" name="phone"
                                                                    required id="">
...
if (isset($_POST['edit'])) {
    $name = $_POST['name'];
    $email = $_POST['email'];
    $phone = $_POST['first_fee'];
    $id = $_POST['id'];
    if (!isset($name, $email, $phone)) {
        alert("Fill Form Properly!");
    } else {
        $conn = connect();
        $ins = $conn->prepare("UPDATE `passenger` SET `name`=?,`email`=?,`phone`=? WHERE id = ?");
        $ins->bind_param("iissiii", $name, $email, $phone, $id);
        $ins->execute();
