                                ...
                                <tbody>
                                    ...
                                    while ($fetch = $row->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo getRoutePath($fetch['route_id']);
                                                $fullname = " Schedule" ?>
                                            </td>
                                            <td>Rp.
                                                <?php echo ($fetch['first_fee']); ?>
                                            </td>
                                            <td>Rp.
                                                <?php echo ($fetch['second_fee']); ?>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <?php echo $fetch['date'], " / ", formatTime($fetch['time']); ?>
                                            </td>
...
if (isset($_POST['del_train'])) {
    $con = connect();
    $disableForeignKey = $con->query("SET foreign_key_checks = 0");
    $conn = $con->query("DELETE FROM schedule WHERE id = '" . $_POST['del_train'] . "'");
    $enableForeignKey = $con->query("SET foreign_key_checks = 1");
